...
import { load2, select, delayAddPaper } from "../../app/paper";
    ...
    <div className="App">
      <form name="frm" action="../bbs" method="post">
        ...
        <div className="mb-3">
          ...
          {me.name === "김세진" ? (
            <button type="button" className="btn lobutton" onClick={onClickDelaySubmit} style={{ margin: 5 }}>
              지연작성test
            </button>
          ) : null}
        </div>
